...
public class LoginStepDefinition {
	...
	public void user_should_land_to_login_page() {
	    WebElement heading =wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//h2[text()='Login Page']")));
	...
	public void user_should_be_successfully_logged_in() {
		  WebElement heading =wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//h2[text()=' Secure Area']")));
		    String headText=heading.getText();
